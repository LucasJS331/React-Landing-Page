...
export const MainTitle = styled.h1`
    color: ${({theme, background})=> background ? theme.colors.light_color : theme.colors.dark_color};
...
export const Heading = ({title, background=false, as= 'h2', size= 'medium'})=>{
    return <MainTitle background={background} as={as} size={size}>{title}</MainTitle>
}
