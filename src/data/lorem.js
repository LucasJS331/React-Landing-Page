export const loremData = {
  title1: 'JANUARY BRINGS US FIREFOX 85',
  text1:
  ...
  title2: 'NEWS COVERAGE AND SOME SURPRISES',
  text2:
  ...
  title3: 'My Grid',
  text3:
    ' Aenean at elit in ligula imperdiet finibus. Ut placerat, ex eu volutpat consequat, nunc risus egestas nisi, vel tincidunt libero metus ac felis.',
  textArr: [
    {
      title: 'Test 1',
      text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.Etiam dapibus lobortis enim eu suscipit. Aliquam ultrices augue in leo volutpat, a lacinia velit varius. Suspendisse ut ex id odio mattis sollicitudin in quis mi.',
    },
    {
      title: 'Test 2',
      text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam dapibus lobortis enim eu suscipit. Aliquam ultrices augue in leo volutpat, a lacinia velit varius. Suspendisse ut ex id odio mattis sollicitudin in quis mi.',
